...
export const corePages = ['home', 'reports', 'about', 'overallPhysicalActivity', 'communityAndBuiltEnvironment', 'school', 'activeTransportation', 'sedentaryBehaviours', 'outdoorAndActivePlay', 'policiesAndInvestments', 'familyAndPeer', 'organisedSports', 'physicalLiteracy'];
